...
public final class filter2 implements Filter {//XssFilter
    static class FilteredRequest extends HttpServletRequestWrapper {
          ...
          //  if ("Tinn".equals(paramName)) {
           // value = sanitize(value);
            //}
                ...
                else if("email".equals(paramName) || "dob".equals(paramName))
                    {
        ...
        {
            StringBuffer val = super.getRequestURL();
            System.out.println("url is  "+val);
            String temp = sanitize(val.toString());
            StringBuffer val1 = new StringBuffer(temp);
            return val1;
