 ...
 * @author nic
 */
public class jsreport2 extends HttpServlet {
...
//            System.out.println("url  " + url + "   " + driver + "   " + username + "   " + password);
...
//            Connection cn = DriverManager.getConnection(url, "vat", "vat");
            // Generate the report
            try {
                System.out.println("rinn " + t);
                ...
                JasperDesign jasperDesign = JRXmlLoader.load(getServletContext().getRealPath("/") + "report/return.jrxml");
