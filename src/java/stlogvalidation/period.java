...
public class period {
    ...
    public boolean isValid() {
        ...
        try {
            ...
            rs = db.execSQL("select max(prd_from_mon),max(prd_from_yr) from master_return_online where vat_rc_no='" + s + "' and prd_from_yr=(select max(prd_from_yr) from master_return_online where vat_rc_no='" + s + "') ");
