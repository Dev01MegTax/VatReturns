...
//dbCon = DriverManager.getConnection("jdbc:oracle:thin://@localhost:1521:orcl", "vat", "vat@123");
    ...
    public ResultSet execSQL(String sql) throws SQLException {
        System.out.println("ddbean------ExecSQL------" + sql);
...
//        System.out.println("ddbean update------------" + sql);
////        Statement s = dbCon.createStatement();
...
//    }
    ...
    public int updateSQL(String sql) throws SQLException {
        ...
        try (PreparedStatement ps = dbCon.prepareStatement(sql)) {
            r = ps.executeUpdate();
            System.out.println("ps.executeUpdate(): " + r);
        } catch (Exception e) {
            System.out.println("updateSQL: " + e.toString());
            throw e;
        }
    ...
    public int execSQLSel(String sql) throws SQLException {
        System.out.println("ddbean------ExecSQLSEL------" + sql);
        Statement s = dbCon.createStatement();
        ResultSet r = s.executeQuery(sql);
        int count = 0;
