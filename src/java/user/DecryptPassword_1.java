...
public class DecryptPassword_1
{
  ...
  String opname="honesty is the best policy";
  byte [] encryptedValue = ep.Encrypt(opname, "mysecretkey");
  System.out.println(Decrypt(encryptedValue, "mysecretkey"));
   }
